...
def add_geographical_Features(forecast, software_data_folder_location):
    ...
    subdistrict_il=up_load_gdb( r'{}\needed_files\subdistrict2008.gdb'.format(software_data_folder_location),'subdistrict2008_ITM')

    muni_JTMT=up_load_gdb( r'{}\needed_files\MUNI_border.gdb'.format(software_data_folder_location),'muni_under_JTMT_ITM')

    jeru_metro_jtmt_border=up_load_shp( r'{}\needed_files\jeru_metro_jtmt_border_221114.shp'.format(software_data_folder_location))
